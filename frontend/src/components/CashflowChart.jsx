  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="mb-4 flex items-center justify-between">
        <h2 className="text-base font-semibold text-slate-900">Cash Flow Trends</h2>
        <span className="text-xs text-slate-400">Revenue / Expenses / Net</span>
      </div>
      ...
      <div className="h-80 w-full">
        <ResponsiveContainer>
          <LineChart data={data} margin={{ top: 10, right: 15, left: 0, bottom: 0 }}>
            ...
            <YAxis tick={{ fontSize: 11, fill: '#64748b' }} tickFormatter={(value) => `$${Math.round(value / 1000)}k`} />
